...
class CartService {
    ...
    fun addProductIntoCart(
        ...
        product: ProductDto,
        amount: Int
    ): Cart = cartRepository.findById(cartId).orElseThrow { CartDoesNotExistException("Cart doesn't exist create it first") }
            .let { cart ->
...
fun changeProductAmount(cartId: Long, cartItem: CartItem, newAmount: Int): Cart {
    ...
    return cartRepository.findById(cartId)
        .orElseThrow { CartDoesNotExistException("Cart doesn't exist create it first") }
}
